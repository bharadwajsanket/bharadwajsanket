...
<table align="center">
  <tr>
    <td align="center">
      <code>[22/tcp]</code>
      <a href="https://github.com/bharadwajsanket">GitHub</a>
      &nbsp;•&nbsp;
      <code>[80/http]</code>
      <a href="https://sanketbharadwaj.vercel.app">Portfolio</a>
      &nbsp;•&nbsp;
      <code>[443/tls]</code>
      <a href="mailto:sanketbharadwaj.dev@gmail.com">Mail</a>
    </td>
  </tr>
</table>
...
<table width="100%">
  <tr>
    <td valign="top" width="55%" style="font-family: monospace; font-size: 13px; line-height: 1.6;">
      <strong>// FIELD OBSERVATIONS & WORKSPACE STATUS</strong>
      <br><br>
    ...
    <td width="5%"></td>
    <td valign="top" width="40%" style="font-family: monospace; font-size: 12px; line-height: 1.5;">
      <strong>// CODESPACE METRICS</strong>
      <br><br>
      <code>[ACTIVE_CORES]   0x04</code><br>
      <code>[PRIMARY_ARCH]   x86_64, ESP32, C99</code><br>
      <code>[COMPILER_TGTS]  nasm, gcc, vyom_vm</code><br>
      <code>[DEBUGGER_OPTS]  gdb -tui -q</code><br>
      <code>[STATUS_REG]     ACTIVE_RUNNING_DEEP_METAL</code>
    </td>
  </tr>
</table>

<hr style="border: 0; border-top: 1px solid #1C1C1F; margin: 30px 0;">

### <a href="https://github.com/bharadwajsanket/vyom">VYOM — Language & Virtual Machine</a>
...
> _Building a tree-walking interpreter is simple. Building a stack-based VM forces you to structure execution frames and address layouts explicitly. Every bytecode instruction is a design compromise between representation density and dispatcher latency._

<hr style="border: 0; border-top: 1px solid #1C1C1F; margin: 30px 0;">

### <a href="https://github.com/bharadwajsanket/qrshare">QRShare</a>
...
> _Eliminating network infrastructure is the ultimate privacy vector. If there is no remote server, there is nothing to intercept. Only photons._

<hr style="border: 0; border-top: 1px solid #1C1C1F; margin: 30px 0;">

### <a href="https://github.com/bharadwajsanket/neotree">Neotree</a>
...
### <a href="https://github.com/bharadwajsanket/sanix">Sanix</a>
...
### <a href="https://github.com/bharadwajsanket/ion">ION — Future Work & Experiments</a>
...
```text
Commit History DAG:
[ Commit Node: A ] ──────> [ Commit Node: B ] ──────> [ Commit Node: C ] (Active HEAD)
  (hash: 4e9c...)            (hash: 8a3f...)            (hash: d2bc...)
```

> _Version control is not a storage repository of files; it is a Directed Acyclic Graph of immutable content states. Tree objects match content hashes directly, making historical logs lightweight and self-describing._

<hr style="border: 0; border-top: 1px solid #1C1C1F; margin: 30px 0;">

<strong>// WORKBENCH SPECIFICATIONS</strong>
<br><br>

<table width="100%">
  <tr>
    <td width="33%" valign="top" style="font-family: monospace; font-size: 12px; line-height: 1.5;">
      <strong>// SYSTEM HEADERS</strong>
      <ul>
    ...
    <td width="33%" valign="top" style="font-family: monospace; font-size: 12px; line-height: 1.5;">
      ...
      <ul>
        <li><code>-Wall -Wextra -O3</code></li>
        <li><code>-std=c99 -pedantic</code></li>
        <li><code>-fno-stack-protector</code></li>
        <li><code>-m32 -march=i386</code></li>
      </ul>
    </td>
    <td width="33%" valign="top" style="font-family: monospace; font-size: 12px; line-height: 1.5;">
      <strong>// LINKER COMMANDS</strong>
      <ul>
        <li><code>ld -m elf_i386 -T link.ld</code></li>
        <li><code>nasm -f bin -o boot.bin</code></li>
        <li><code>objcopy -O binary</code></li>
        <li><code>gdb -symbols=boot.elf</code></li>
      </ul>
    </td>
  </tr>
</table>
...
<table width="100%">
  <tr>
    <td style="font-family: monospace; font-size: 12px; line-height: 1.6;">
      <strong>// DISCIPLINE FIELD NOTES (BOOKSHELF)</strong>
      <br><br>
      <strong>[Vol_0x0A] Crafting Interpreters</strong> — <em>Robert Nystrom</em>
      <br>
      ...
      <br><br>
      <strong>[Vol_0x0B] OS: Three Easy Pieces</strong> — <em>Arpaci-Dusseau</em>
      <br>
      "Operating systems are the art of virtualization. We trick user application loops into believing they own absolute resources, all while organizing memory paging registers, kernel tables, and raw IO hardware context switches."
      <br><br>
      <strong>[Vol_0x0C] Computer Systems: CS:APP</strong> — <em>Bryant & O'Hallaron</em> (Queued)
      <br>
      <strong>[Vol_0x0D] Designing Data-Intensive Applications</strong> — <em>Martin Kleppmann</em> (Queued)
    </td>
  </tr>
</table>

<hr style="border: 0; border-top: 1px solid #1C1C1F; margin: 40px 0 20px 0;">
